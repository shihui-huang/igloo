...
\usecase{\haute}{Créer un client}
               %% précondition
                    {\\nom et prénom du client bien formées (non \nullvalue et non vide)\\
...
\smallskip
           ...
           \usecase{\haute}{Libérer une chambre}
                %% précondition
                    ...
                    $\land$ paire de clés du badge d'accès bien formées (non \nullvalue et non vide)}
                %% postcondition
                    {\\paire de clés du badge d'accès effacée (\nullvalue ou vide)\\
...
\item \textsf{Chambre}~---~identifiant, graine, sel, clé1, clé2
...
\item \textsf{Badge}~---~identifiant, clé 1, clé 2
